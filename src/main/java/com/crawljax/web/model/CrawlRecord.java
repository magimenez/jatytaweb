...
import com.crawljax.web.jatyta.utils.DateUtils;
...
public class CrawlRecord {
	...
	public void setStartTime(Date startTime) {
		...
		this.startTimeFormatted = DateUtils.dateFormatted(startTime);
	}
	...
	/**
	 * Return the href for the configuration id
	 * 
	 * @author mgimenez
	 * @return A String with the href of the configuration.
	 */
