...
public class Configuration {
	...
	// mgimenez: add proxy configuration
	private ProxyType proxyType = ProxyType.NOTHING;
	private String proxyHostName = "proxy";
	...
	// mgimenez: add setters and getters of proxy configuration
	/**
	 * 
