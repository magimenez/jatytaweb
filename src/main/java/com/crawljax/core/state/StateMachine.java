...
public class StateMachine {
	...
	public boolean swithToStateAndCheckIfClone(final Eventable event, StateVertex newState,
		...
		if (cloneState == null) {
			//2016-07-12 mgimenez: luego de disparar el evento, 
			//correr nuevos plugins
			plugins.runOnFireEventSuccessPlugins(context, currentState,newState, 
					null);
			...
			//2016-07-12 mgimenez: luego de disparar el evento, 
			//correr nuevos plugins
			plugins.runOnFireEventSuccessPlugins(context, currentState,cloneState, 
					null);
