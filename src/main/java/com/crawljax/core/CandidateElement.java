...
public class CandidateElement {
	...
	//mgimenez: state title name
	private String stateTitleName;
	
	private static final Logger LOG = LoggerFactory.getLogger(CandidateElement.class);
	...
	public String getUniqueString() {
		...
		//mgimenez: add the state title name
		result += this.stateTitleName;

		LOG.debug("UniqueString : {} ", result);
	...
	/**
	 * @return the stateTitleName
	 */
	public String getStateTitleName() {
		return stateTitleName;
	}

	/**
	 * @param stateTitleName the stateTitleName to set
	 */
	public void setStateTitleName(String stateTitleName) {
		this.stateTitleName = stateTitleName;
	}
