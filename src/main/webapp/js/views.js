...
Ember.Handlebars.helper('autocomplete', App.PropNamesSearchBoxView);
...
App.NumberField = Ember.TextField.extend({
	classNames: ['form-control', 'number-input'],
    type: 'number',
	attributeBindings: ['min', 'max', 'step']
});

App.TextAreaField = Ember.TextArea.extend({
	classNames: ['form-control', 'textarea-input'],
